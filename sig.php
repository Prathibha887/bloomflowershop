...
<head>
  ...
  <style>
:root {
    --primary-color:#e561b9;;
   
    --secondary-color: #e561b9;
    --black: #000000;
    --white: #ffffff;
    --gray: #efefef;
    --gray-2: #757575;
...
$query = "INSERT INTO user(username,email,contact,password,address) VALUES('".$username."','".$email."','".$contact."','".$password."','".$address."')";
