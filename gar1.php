...
<head>
    ...
    <!-- Site Metas -->
    <title>Yasmiin - Ecommerce Bootstrap 4 HTML Template</title>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbar-menu">
                    <ul class="nav navbar-nav ml-auto" data-in="fadeInDown" data-out="fadeOutUp">
                        ...
                        <li class="nav-item"><a class="nav-link" href="simply.php">SignIn/Login</a></li>
                    </ul>
                </div>
                <!-- /.navbar-collapse -->
...
$sql1 = "select * from ouerservice where categories='".$serv."'";
...
?>
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <div class="shop-cat-box">
                        <img class="img-fluid" src="./admin/our/<?php echo $image; ?>" alt="" />
                        <a class="btn hvr-hover" href="gar2.php?serv=<?php echo $id; ?>"><?php echo $service; ?></a>
                    </div>
                </div>
