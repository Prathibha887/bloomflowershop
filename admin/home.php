...
<head>
	<!-- Basic Page Info -->
	<meta charset="utf-8">
	<title>Admin-The Bloom Flower Shop</title>
			...
			<div class="sidebar-menu">
				<ul id="accordion-menu">
					...
					<a href="upcoming.php" class="dropdown-toggle no-arrow">
							<i class="icon-copy ion-ios-pricetag"></i><span class="mtext">Upcoming Events</span>
						</a>
				...
				<div class="row align-items-center">
					...
					<div class="col-md-8">
						<h4 class="font-20 weight-500 mb-10 text-capitalize">
							Welcome back <div class="weight-600 font-30 text-blue">The Bloom Flower Shop</div>
						</h4>
						<p class="font-18 max-width-600"> The Bloom Flower Shop Flower Decoration Company has been blooming since 2013.At The Bloom Flower Shop, our mission is to transform your events into captivating visual narratives. We believe that every celebration deserves a touch of nature's elegance. </p>
				</div>
			</div>
			<div class="pd-20 card-box mb-30" style="margin-top:40px;">
					<div class="clearfix">
						<div class="pull-left">
...
if(isset($_POST['submit']))
{
	...
	include("config.php");
	   $name=$_POST['name'];
		...
		{
			$query ="INSERT INTO best(image,product,price) VALUES('".$filename."',' ".$product." ',' ".$price." ')";
...
?>
						...
						<tr>
							<td class="table-plus">
								<img  src="best/<?php echo $image; ?>" width="70" height="70" alt="">
							</td>
...
$query1 = "delete from best where id='".$selectano."'";

mysqli_query($con,$query1) or die(mysqli_error($con));

echo "<script> location.href='best.php'; </script>";
