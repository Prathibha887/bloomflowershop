		...
		<div class="menu-block customscroll">
			<div class="sidebar-menu">
				<ul id="accordion-menu">
						...
						<a href="upcoming.php" class="dropdown-toggle no-arrow">
							<span class="micon dw dw-house-1"></span><span class="mtext">Upcoming</span>
						</a>
		...
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
				...
				<div class="pd-20 card-box mb-30">
					<div class="clearfix">
						<div class="pull-left">
							<h4 class="text-blue h4">Our Product</h4>
					...
					<form method="post" action="#" enctype="multipart/form-data">
						...
						<div class="form-group row">
							...
							<div class="col-sm-12 col-md-10">
								<input type="text"  name="product" class="form-control-file form-control height-auto" placeholder="Product">
							</div>
						...
						<div class="form-group row">
							...
							<div class="col-sm-12 col-md-10">
								<input type="text"  name="event" class="form-control-file form-control height-auto" placeholder="Product">
							</div>
...
if(isset($_POST['submit']))
{
	...
	include("config.php");
	   $name=$_POST['name'];
        ...
        $folder = "upcoming/".$filename;
		
        if (move_uploaded_file($tempname, $folder))  
		{
			$query ="INSERT INTO upcoming(image,product,rate,event) VALUES('".$filename."','".$product."','".$rate."','".$event."')";
            mysqli_query($con, $query);
			echo "<script>
					alert(' uploaded Successfully');
				</script>";
			echo "<script> location.href='upcoming.php'; </script>";
        }else{
            echo "<script>
...
<div class="pd-20 card-box mb-30">
					<div class="clearfix mb-20">
						<div class="pull-left">
							<h4 class="text-blue h4">View Our Products </h4>
...
?>
							...
							<tr>
								...
								<td><img src="upcoming/<?php echo $image; ?>"  style="width:130px;height:110px;"></td>
								<th scope="col"><?php echo $product; ?></th>
								<th scope="col"><?php echo $event; ?></th>
...
$query1 = "delete from upcoming where id='".$selectano."'";
