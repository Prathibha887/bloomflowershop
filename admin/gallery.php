		...
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
				...
				<div class="pd-20 card-box mb-30">
					<div class="clearfix">
						<div class="pull-left">
							<h4 class="text-blue h4">Add Gallery Image</h4>
					...
					<form method="post" action="#" enctype="multipart/form-data">
						...
						<button type="submit" value="Submit" name="submit" class="btn btn-outline-primary" style="margin-left:180px;">Submit</button>
					</form>
						<?php					 						 
...
<div class="pd-20 card-box mb-30">
					<div class="clearfix mb-20">
						<div class="pull-left">
							<h4 class="text-blue h4">View Gallery Images</h4>
...
?>					
							...
							<tr>
								...
								<td><img src="gallery/<?php echo $image; ?>" style="width:130px;height:110px;"></td>
								<td>
...
$query1 = "delete from gallery where id='".$selectano."'";
