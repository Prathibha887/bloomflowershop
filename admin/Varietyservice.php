...
<body>
	...
	<div class="main-container">
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
				...
				<div class="pd-20 card-box mb-30">
					<div class="clearfix">
						<div class="pull-left">
							<h4 class="text-blue h4">Our Services</h4>
		...
		<div class="col-sm-12 col-md-10">
			<select class="custom-select col-12" name="categories">
				<option selected="">Choose...</option>
				<?php

include 'config.php';

$sql1 = "select * from ouerservice";
...
?>
				<option value="<?php echo $id; ?>"><?php echo $id; ?>.<?php echo $service; ?></option>
				<?php
...
?>	
						...
						<div class="form-group row">
							...
							<div class="col-sm-12 col-md-10">
								<input type="text" name="service"  class="form-control-file form-control height-auto" placeholder=" Service">
							</div>
						...
						<div class="form-group row">
							...
							<div class="col-sm-12 col-md-10">
								<input type="text"  name="rate"class="form-control-file form-control height-auto" >
							</div>
							
						</div>
						<button type="submit" name="submit" value="Submit" class="btn btn-outline-primary" style="margin-left:180px;" onclick="window.location.href='home.php';">Submit</button>
					</form>
...
if(isset($_POST['submit']))
{
	...
	include("config.php");
	   $name=$_POST['name'];
        ...
        $folder = "Variety/".$filename;
		
        if (move_uploaded_file($tempname, $folder))  
		{
			$query ="INSERT INTO varietyservice(image,service,categories,rate) VALUES('".$filename."','".$service."','".$categories."','".$rate."')";
            mysqli_query($con, $query);
			echo "<script>
					alert(' uploaded Successfully');
				</script>";
			echo "<script> location.href='Varietyservice.php'; </script>";
        }else{
            echo "<script>
...
<div class="pd-20 card-box mb-30">
					<div class="clearfix mb-20">
						<div class="pull-left">
							<h4 class="text-blue h4">View Our Services </h4>
					...
					<table class="table " style="border-top:0;">
						<thead>
							<tr>
								...
								<th scope="col">Our Vareity Name</th>
...
$sql1 = "select * from varietyservice";
...
?>
							...
							<tr>
								...
								<td><img src="variety/<?php echo $image; ?>" style="width:130px;height:110px;"></td>
...
$query1 = "delete from varietyservice where id='".$selectano."'";
