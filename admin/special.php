		...
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
				...
				<div class="pd-20 card-box mb-30">
					<div class="clearfix">
						<div class="pull-left">
							<h4 class="text-blue h4">Special Offers</h4>
...
if(isset($_POST['submit']))
{
	...
	include("config.php");
	   $name=$_POST['name'];
        ...
        $folder = "special/".$filename;
		
        if (move_uploaded_file($tempname, $folder))  
		{
			$query ="INSERT INTO special(image) VALUES('".$filename."')";
            mysqli_query($con, $query);
			echo "<script>
					alert(' uploaded Successfully');
				</script>";
			echo "<script> location.href='special.php'; </script>";
        }else{
            echo "<script>
...
<div class="pd-20 card-box mb-30">
					<div class="clearfix mb-20">
						<div class="pull-left">
							<h4 class="text-blue h4">Special Offer</h4>
...
?>
							...
							<tr>
								...
								<td><img src="special/<?php echo $image; ?>" style="width:130px;height:110px;"></td>
								<td>
...
<input type="text" name="id[]" value="<?php echo $id; ?>" hidden="true">
							...
							<!--<tr>
								<th scope="row">2</th>
								<td><img src="img/v.png"style="width:130px;height:110px;"></td>
...
$query1 = "delete from special where id='".$selectano."'";
