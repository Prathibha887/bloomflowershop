...
<div class="pd-20 card-box mb-30">
					<div class="clearfix mb-20">
						<div class="pull-left">
							<h4 class="text-blue h4">View Orders</h4>
					...
					<table class="table " style="border-top:0;">
						...
						<tbody>
							<tr>
								...
								<td><img src="img/orchi1.jpg"style="width:130px;height:110px;"></td>
								<th scope="col">Perfect Orchid Garland</th>
								<th scope="col">Rs.4600/-onwards</th>
								<th scope="col">Prapthi
								<br>prapthi20@gmain.com<br>tbfspmwdinter1</th>
								<th scope="col">8976543523</th>
							...
							<tr>
								...
								<td><img src="img/royal.png"style="width:130px;height:110px;"></td>
								<th scope="col">Royal Lotus Garland</th>
								<th scope="col">Rs.4600/-onwards</th>
								<th scope="col">Arjun
								<br>arjun21@gmain.com<br>tbfspmwdinter5</th>
								<th scope="col">8907988787</th>
								<td><button type="submit" class="btn btn-outline-danger">Delete</button></td>
							</tr>
