...
<div class="pd-20 card-box mb-30">
					<div class="clearfix mb-20">
						<div class="pull-left">
							<h4 class="text-blue h4">View Ordered Products</h4>
					...
					<table class="table " style="border-top:0;">
						...
						<tbody>
							<tr>
								...
								<td><img src="img/mallige.jpg"style="width:130px;height:110px;"></td>
								<th scope="col">Mangalore Mallige or Jasmin</th>
								
								<th scope="col">One Chendu</th>
								<th scope="col">Rs.150/-</th>
								<th scope="col">5</th>
								<th scope="col">Rs.750</th>
								<th scope="col">Prapthi
								<br>prapthi20@gmain.com<br>tbfspmwdinter1<br>8976543523</th>
							...
							<tr>
								...
								<td><img src="img/rosee.jpg"style="width:130px;height:110px;"></td>
								<th scope="col">Red Rose</th>
								
								<th scope="col">One Piece</th>
								<th scope="col">Rs.15/-</th>
								<th scope="col">6</th>
								<th scope="col">Rs.90</th>
								<th scope="col">Arjun
								<br>arjun21@gmain.com<br>tbfspmwdinter5<br>8907988787</th>
								<td><button type="submit" class="btn btn-outline-danger">Delete</button></td>
							</tr>
