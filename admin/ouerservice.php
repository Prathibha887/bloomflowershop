...
<body>
	...
	<div class="main-container">
		...
		<label class="col-sm-12 col-md-2 col-form-label">Main Categories</label>
...
if(isset($_POST['submit']))
{
	...
	include("config.php");
	   $name=$_POST['name'];
		...
		{
			$query ="INSERT INTO ouerservice(image,service,categories) VALUES('".$filename."','".$service."','".$categories."')";
            mysqli_query($con, $query);
			echo "<script>
					alert(' uploaded Successfully');
				</script>";
			echo "<script> location.href='ouerservice.php'; </script>";
        }else{
            echo "<script>
...
?>
						...
						<tr>
								...
								<td><img src="our/<?php echo $image; ?>" style="width:130px;height:110px;"></td>
...
$query1 = "delete from ouerservice where id='".$selectano."'";
