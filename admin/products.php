				...
				<div class="pd-20 card-box mb-30">
					...
					<form method="post" action="#" enctype="multipart/form-data">
						...
						<div class="form-group row">
							...
							<label class="col-sm-12 col-md-2 col-form-label">Type Of Rate:</label>
							<div class="col-sm-12 col-md-10">
								<input type="text"  name="type" class="form-control-file form-control height-auto"  placeholder="single">
							</div>
						...
						<div class="form-group row">
							...
							<div class="col-sm-12 col-md-10">
								<input type="text" name="description" class="form-control-file form-control height-auto" placeholder="description">
							</div>
...
if(isset($_POST['submit']))
{
	...
	include("config.php");
	   $name=$_POST['name'];
		...
		{
			$query ="INSERT INTO product(image,product,rate,type,description) VALUES('".$filename."','".$product."','".$rate."','".$type."','".$description."')";
...
?>
							...
							<tr>
								...
								<td><img src="product/<?php echo $image; ?>"  style="width:130px;height:110px;"></td>
...
$query1 = "delete from product where id='".$selectano."'";
