		...
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
				...
				<div class="pd-20 card-box mb-30">
					<div class="clearfix">
						<div class="pull-left">
							<h4 class="text-blue h4">Main Services</h4>
				...
				<form method="post" action="#" enctype="multipart/form-data">
						...
						<div class="form-group row">
							...
							<label class="col-sm-12 col-md-2 col-form-label">Main Service</label>
							<div class="col-sm-12 col-md-10">
								<input type="text" name="service" class="form-control-file form-control height-auto" placeholder="Add Main Service Name">
							</div>
...
if(isset($_POST['submit']))
{
	...
	include("config.php");
	   $name=$_POST['name'];
		...
		{
			$query ="INSERT INTO mainservice(image,service) VALUES('".$filename."','".$service."')";
            mysqli_query($con, $query);
			echo "<script>
					alert(' uploaded Successfully');
				</script>";
			echo "<script> location.href='mainservice.php'; </script>";
        }else{
            echo "<script>
					...
					<table class="table " style="border-top:0;">
						<thead>
							<tr>
								...
								<th scope="col">Main Service Image</th>
...
?>
				<tr>
								...
								<td><img src="main/<?php echo $image; ?>" style="width:130px;height:110px;"></td>
...
$query1 = "delete from mainservice where id='".$selectano."'";
