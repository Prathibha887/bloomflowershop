		...
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
						...
						<div class="col-md-6 col-sm-12">
							...
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page">About Flowers</li>
								</ol>
							</nav>
						</div>
				...
				<div class="pd-20 card-box mb-30">
					<div class="clearfix">
						<div class="pull-left">
							<h4 class="text-blue h4">About Flowers</h4>
					...
					<form method="post" action="#" enctype="multipart/form-data">
						...
						<div class="form-group row">
							...
							<label class="col-sm-12 col-md-2 col-form-label">Heading/Subject</label>
							<div class="col-sm-12 col-md-10">
								<input type="text" name="heading" class="form-control-file form-control height-auto" placeholder="Heading/Subject of the flowers">
							</div>
							
						</div>
						<div class="form-group row">
						
							<label class="col-sm-12 col-md-2 col-form-label">Description/About Flowers</label>
							<div class="col-sm-12 col-md-10">
								<input type="text" name="description" class="form-control-file form-control height-auto" placeholder="Write Some Flower Content" >
							</div>
...
if(isset($_POST['submit']))
{
	...
	include("config.php");
	   $name=$_POST['name'];
        ...
        $folder = "about/".$filename;
		
        if (move_uploaded_file($tempname, $folder))  
		{
			$query ="INSERT INTO about(image,description,heading) VALUES('".$filename."','".$heading."','".$description."')";
...
?>
							...
							<tr>
								...
								<td><img  src="about/<?php echo $image; ?>" style="width:220px;height:140px;"></td>
								<th scope="col" style="width:300px;"><?php echo $heading; ?></th>
								<th scope="col" style="width:300px;"><?php echo $description; ?></th>
								<td>
...
$query1 = "delete from about where id='".$selectano."'";
