            ...
            <div class="row">
                <div class="col-xl-9 col-lg-9 col-sm-12 col-xs-12 shop-content-right">
                    <div class="right-product-box">
						...
						<h1 style="font-family:verdana;background:#e561b9;">Our Exiting Products</h1><br>
                                        ...
                                        <div class="col-sm-6 col-md-6 col-lg-4 col-xl-4">
                                            <div class="products-single fix">
                                                <div class="box-img-hover">
                                                    ...
                                                    <img src="../admin/product/<?php echo $image; ?>" class="img-fluid" alt="Image">
                                                    <div class="mask-icon">
                                                        
                                                        <a class="cart" href="des.php?des=<?php echo $id;?>" >View Details</a>
                                                    </div>
                                                </div>
                                                <div class="why-text">
                        ...
                        <div class="filter-sidebar-left">
                            ...
                            <div class="list-group list-group-collapse list-group-sm list-group-tree" id="list-group-men" data-children=".sub-men">
                                <div class="list-group-collapse sub-men">
                                    <a class="list-group-item list-group-item-action" href="#sub-men1" data-toggle="collapse" aria-expanded="true" aria-controls="sub-men1">Flowers And Events</small>
								</a>
