...
.form-container input[type=text], .form-container input[type=email], .form-container input[type=tel],.form-container input[type=date],.form-container select {
  width: 770px;
  padding: 15px;
  margin: 5px 0 22px 0;
  border: none;
...
.form-container input[type=text]:focus, .form-container input[type=email]:focus ,.form-container input[type=tel]:focus ,.form-container input[type=date]:focus,.form-container select:focus  {
...
<body>
	...
	<div class="feedback" style="margin-left:300px;background:lightgrey;width:800px;border:4px solid deeppink;border-radius:20px;height:930px;margin-bottom:50px;margin-top:60px;">
	<!--<form>
	<h1 style="margin-left:300px;font-size:35px;font-weight:bold;margin-top:30px;">Feedback</h1>-->
  <form method="post" action="#" enctype="multipart/form-data" class="form-container">

	<h1 style="margin-left:300px;font-size:35px;font-weight:bold;margin-top:30px;">Booking</h1>
    <label for="user" style="margin-top:0px;"><b>Username</b></label><br>
    <input type="text" placeholder="Your name" name="user"  required><br><br>

    <label for="email"><b>Email</b></label><br>
    <input type="email" placeholder="Enter Email" name="email"   required ><br><br>
      
       <label for="contact" style="margin-left:-90px;"><b>Contact</b></label><br>
    <input type="tel"  name="contact" placeholder="your Contact"  required><br><br>
	<label for="cars">Choose Product:</label>
  <select name="product" id="cars" style="margin-bottom:30px;">
    <option value="Mangalore Mallige Or Jasmine">Mangalore Mallige Or Jasmine</option>
    <option value="Mangalore Sevantige">Mangalore Sevantige</option>
    <option value="Avantika(Flower bouquet)">Avantika(Flower bouquet)</option>
    <option value="Varnan(Varmala)">Varnan(Varmala)</option>
	<option value="Granula(Flower Box)">Granula(Flower Box)</option>
	<option value="Red Rose">Red Rose</option><br><br>
	
	
  </select>
	<label for="date" ><b>Delivery Date</b></label><br>
    <input type="date"  name="date" value="<?php echo date('y-m-d'); ?>" style="margin-bottom:10px;"  required><br><br>
	
	
       <label for="address" style="margin-left:-40px;"><b>Delivery Address</b></label><br>
    <input type="text"   name="address" placeholder="Enter Delivery Address"  style="height:100px;margin-bottom:20px;" required><br><br>
...
if(isset($_POST['submit']))
{
	...
	include("config.php");
	   ...
	   $product=$_POST['product'];
			...
			$query ="INSERT INTO prodbooking(user,email,address,contact,product,date) VALUES('".$user."','".$email."','".$address."','".$contact."','".$product."','".$date."')";
