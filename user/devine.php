            ...
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <div class="shop-cat-box">
                        <img class="img-fluid" src="img/church3.jpg" alt="" />
                        <a class="btn hvr-hover" href="church.php">Church Decoration</a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <div class="shop-cat-box">
                        <img class="img-fluid" src="img/temple8.jpg" alt="" />
                        <a class="btn hvr-hover"  href="temple.php">Temple  Decoration</a>
                    </div>
                </div>
            </div>
        </div>
