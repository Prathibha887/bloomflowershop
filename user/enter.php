            ...
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <div class="shop-cat-box">
                        <img class="img-fluid" src="img/hoenter5.jpg" alt="" />
                        <a class="btn hvr-hover" href="hoenter.php">Marriage House Entrance Decoration</a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <div class="shop-cat-box">
                        <img class="img-fluid" src="img/menter1.jpg" alt="" />
                        <a class="btn hvr-hover"  href="menter.php">Mehendi Entrance Decoration</a>
                    </div>
                </div>
				<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <div class="shop-cat-box">
                        <img class="img-fluid" src="img/wenter3.jpg" alt="" />
                        <a class="btn hvr-hover"  href="wenter.php">Marriage Hall Entrance Decoration</a>
                    </div>
                </div>
