                ...
                <div class="collapse navbar-collapse" id="navbar-menu">
                    <ul class="nav navbar-nav ml-auto" data-in="fadeInDown" data-out="fadeOutUp">
                      ...
                      <li class="nav-item"><a class="nav-link" href="account.php">Account</a></li>
						...
						<li class="nav-item active"><a class="nav-link" href="myorder.php">Myorder</a></li>
                ...
                <div class="col-lg-12">
                    <div class="table-main table-responsive">
                        <table class="table" width="300px">
                            <thead>
							<h1 style="font-size:35px;font-weight:bold;">Your Ordered Design</h1>
                                <tr>
                                    <th>Images</th>
                                    <th>Product Name</th>
                                    <th>Price </th>
                            ...
                            <tbody>
                                <tr>
                                    <td class="thumbnail-img">
                                        <a href="#">
									<img class="img-fluid" src="img/jasrose.jpg" alt="" />
								</a>
                                    </td>
                                    <td class="name-pr">
                                        <a href="#">
								Jasmin With Red Rose
								</a>
                                    </td>
                                    <td class="price-pr">
                                        <p>Rs.2500/-onwards</p>
                                    </td>
                                    <td class="quantity-box">We will contact you soon,if not please contact with us 8956453212</td>
                                ...
                                <tr>
                                    <td class="thumbnail-img">
                                        <a href="#">
									<img class="img-fluid" src="img/whity.jpg" alt="" />
								</a>
                                    </td>
                                    <td class="name-pr">
                                        <a href="#">
									Indian White Garland
								</a>
                                    </td>
                                    <td class="price-pr">
                                        <p>Rs.2500/-onwards</p>
                ...
                <div class="col-lg-12">
                    <div class="table-main table-responsive">
                        <table class="table" width="300px">
                            ...
                            <tbody>
							<h1 style="font-size:35px;font-weight:bold">Your Ordered Products</h1>
                                <tr>
                                    <td class="thumbnail-img">
                                        <a href="#">
									<img class="img-fluid" src="img/mallige.jpg" alt="" />
								</a>
                                    </td>
                                    <td class="name-pr">
                                        <a href="#">
                                ...
                                <tr>
                                    <td class="thumbnail-img">
                                        <a href="#">
									<img class="img-fluid" src="img/sevantige.jpg" alt="" />
								</a>
                                    </td>
                                    <td class="name-pr">
                                        <a href="#">
