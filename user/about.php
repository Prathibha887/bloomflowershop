...
<style> 
		...
		.bi bi-star-half{            color : orange;  
            font-size : 20px;  
		}
		.hover-team:hover{transform:scale(1.1);
box-shadow:0 4px 8px 0 rgba(10,10,10,0.2), 0 6px 20px 0 rgba(10,10,10,0.19);
...
<body>
    ...
    <div class="about-box-main">
        <div class="container">
            <div class="row">
				<div class="col-lg-6">
                    <div class="banner-frame"> <img class="img-fluid" src="img/shop.jpg" alt="" />
                    </div>
                </div>
                <div class="col-lg-6">
                    <h2 class="noo-sh-title-top">We are <span>The Bloom Flower Shop</span></h2>
                    <p>Welcome to The Bloom Flower Shop, where floral artistry blossoms into unforgettable moments. We are a passionate team dedicated to bringing the beauty of nature into your special occasions through exquisite flower decorations.Founded with a love for flowers and a commitment to turning ordinary spaces into extraordinary experiences, The Bloom Flower Shop Flower Decoration Company has been blooming since 2013. What started as a humble endeavor by yashmin shetty has now flourished into a thriving business known for its creativity, attention to detail, and personalized service.At The Bloom Flower Shop, our mission is to transform your events into captivating visual narratives. We believe that every celebration deserves a touch of nature's elegance, and our team works tirelessly to curate floral designs that reflect your unique style and aspirations. Whether it's a wedding, corporate event, or a simple gathering, we strive to enhance the atmosphere with the timeless charm of flowers.</p>
                    <p>The Bloom Flower Shop Flower Decoration Company is not just about flowers; it's about transforming spaces and creating memories that last a lifetime. Join us in this floral journey, where every petal tells a story.</p>
            ...
            <div class="row my-5">
                <div class="col-sm-6 col-lg-4">
                    <div class="service-block-inner">
                        ...
                        <p>We are the company who belive in building trust so over the year we are having more than 1lakh trusted customer and still list is growing beyond the bounds and seas</p>
                    </div>
                </div>
                <div class="col-sm-6 col-lg-4">
                    <div class="service-block-inner">
                        <h3>We are Professional</h3>
                        <p>Although we treat our customer as our friend when it comes to work we are very professional we wont mix our friendliness to our professional work.always know our boundries. </p>
                    </div>
                </div>
                <div class="col-sm-6 col-lg-4">
                    <div class="service-block-inner">
                        <h3>We are Expert</h3>
                        <p>We are having huge team who all enough experience and expertise in this industry they work hard with their professional knowldge to make things look beautifull and give life to youre dream. </p>
                    </div>
                </div>
            </div>
