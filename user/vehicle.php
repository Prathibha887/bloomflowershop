            ...
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <div class="shop-cat-box">
                        <img class="img-fluid" src="img/bus4.jpg" alt="" />
                        <a class="btn hvr-hover" href="bus.php">Bus Decoration</a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <div class="shop-cat-box">
                        <img class="img-fluid" src="img/car3.jpeg" alt="" />
                        <a class="btn hvr-hover"  href="car.php">Car  Decoration</a>
                    </div>
                </div>
            </div>
        </div>
