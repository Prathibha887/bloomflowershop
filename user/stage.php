            ...
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <div class="shop-cat-box">
                        <img class="img-fluid" src="img/royal5.jpg" alt="" />
                        <a class="btn hvr-hover" href="royal.php">Royal Stage Decoration</a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <div class="shop-cat-box">
                        <img class="img-fluid" src="img/indoor1.jpg" alt="" />
                        <a class="btn hvr-hover"  href="indoor.php">Indoor Stage Decoration</a>
                    </div>
                </div>
                 <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <div class="shop-cat-box">
                        <img class="img-fluid" src="img/outdoor7.jpg" alt="" />
                        <a class="btn hvr-hover"  href="outdoor.php">Outdoor Stage Decoration</a>
                    </div>
                </div>
            </div>
        </div>
