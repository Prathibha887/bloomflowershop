...
<body>
	...
	<div class="categories-shop">
        <div class="container">
		<h1 class="update" style="font-family:verdana;font-weight:bold;font-size:30px;background:#e561b9;">New Year</h1><br>
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <div class="shop-cat-box">
                        <img class="img-fluid" src="p.jpeg" alt="" height="100px"/>
                        <a class="btn hvr-hover" href="#">Rs 500</a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <div class="shop-cat-box">
                        <img class="img-fluid" src="new.jpg" alt="" />
                        <a class="btn hvr-hover" href="#">New Year</a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <div class="shop-cat-box">
                        <img class="img-fluid" src="pro.jpeg" alt="" />
                        <a class="btn hvr-hover" href="#">Valentinesday</a>
                    </div>
                </div>
            </div>
        </div>
