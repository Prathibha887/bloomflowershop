            ...
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <div class="shop-cat-box">
                        <img class="img-fluid" src="img/henter.jpg" alt="" />
                        <a class="btn hvr-hover" href="hdecor2.php">House Entrance Decoration</a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <div class="shop-cat-box">
                        <img class="img-fluid" src="img/eroom3.png" alt="" />
                        <a class="btn hvr-hover"  href="room.php">Room Decoration</a>
                    </div>
                </div>
